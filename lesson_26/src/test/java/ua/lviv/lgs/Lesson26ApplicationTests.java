...
class ApplicationTests {
    ...
    public void testSaveToBucket(){
        ...
        assertEquals(informationFromDb.getUser(), userFromDb);
        assertEquals(informationFromDb.getFaculty(), facultyFromDb);
        assertEquals(informationFromDb.getEnglishScore(), information.getEnglishScore());
        assertEquals(informationFromDb.getHistoryScore(), information.getHistoryScore());
        assertEquals(informationFromDb.getMathScore(), information.getMathScore());
